...
ASSISTANT_ID = "asst_C3Mipy0XBrRiE3Bjoj3RjCoO"
...
st.image("elijah-logo.png", width=180)
...
<div style="background-color: #fff8dc; padding: 10px; border: 1px solid #ddd; border-radius: 5px; margin-top: 15px;">
    <strong>Note:</strong> This is just a basic demo layout to test the backend(knowledge and query handling capabilities) of Elijah's Xtream Customer Support AI. The final frontend will not look like this. Specific information about products or offers can also be added later on. Email us at 'hello@altorix.co.uk'.
</div>
""", unsafe_allow_html=True)
